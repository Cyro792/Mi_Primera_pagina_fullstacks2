...
function MapSection() {
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current).setView([CLINIC_LAT, CLINIC_LNG], 15);
    ...
    L.marker([CLINIC_LAT, CLINIC_LNG])
      .addTo(map)
      .bindPopup("<b>Clínica Veterinaria San Marcos</b><br>Rancagua, Chile")
      .openPopup();
